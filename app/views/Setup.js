...
module.exports = {
    view() {
        return <div id="starting" style="top:0;overflow-y:scroll;" class="absolute w-full h-full">
            <div style="width:80%" class="mx-auto bg-white mb-4 mt-4 p-4 rounded-lg shadow">
                ...
                <div class="flex">
                    <div class="flex-1">
                        ...
                        <div class="p-4">
                            <div class="mb-8">Create a spreadsheet for your humans that looks like the below and paste the URL in below.
                    ...
                    <div class="flex-1 ml-8">
                        ...
                        <div class="p-4">
                            <div class="mb-8">Create a spreadsheet for your bets looks like the below and paste the URL in below.
